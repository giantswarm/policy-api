...
func (in *PolicyExceptionStatus) DeepCopyInto(out *PolicyExceptionStatus) {
	*out = *in
	...
	if in.GeneratedExceptions != nil {
		in, out := &in.GeneratedExceptions, &out.GeneratedExceptions
		*out = make([]GeneratedException, len(*in))
		copy(*out, *in)
	}
	if in.UnresolvedPolicies != nil {
		in, out := &in.UnresolvedPolicies, &out.UnresolvedPolicies
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
	if in.UnsupportedTargetKinds != nil {
		in, out := &in.UnsupportedTargetKinds, &out.UnsupportedTargetKinds
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
}
