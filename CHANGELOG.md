...
- Add a `status` subresource to `PolicyException` for kyverno-policy-operator: `Ready`, `PoliciesResolved` and `TargetsTranslated` conditions, the generated Kyverno PolicyExceptions, unresolved policies and unsupported target kinds. `kubectl get gspolex` shows `Ready` and `Reason`.
...
[Unreleased]: https://github.com/giantswarm/policy-api/compare/v0.0.6...HEAD
[0.0.6]: https://github.com/giantswarm/policy-api/compare/v0.0.5...v0.0.6
